...
class ObjectLoader {
    ...
    setSequence(sequence) {
        if(Array.isArray(sequence) && sequence.length > 0) {
            ...
            throw new TypeError('The loader sequence is to be an array! (' + (typeof sequence) + ' given)');
     ...
     */
    setCaching(cache) {
        this.allow_cache = cache !== undefined ? cache : true;
     ...
     */
    _resolve(identifier) {
        for(var sequence of this.sequence) {
            var ident = this._parseSequence(sequence, identifier),
